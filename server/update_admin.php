...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    try {
        ...
        header('Location: ../pages/admin-settings.php?section=account&error=Wrong Password');
        exit();
        }
        ...
        header('Location: ../pages/admin-settings.php?section=account&success=Updated Successfully');
    } catch (Exception $e) {
        header('Location: ../pages/admin-settings.php?section=account&error=Wrong Password');
    }
}
